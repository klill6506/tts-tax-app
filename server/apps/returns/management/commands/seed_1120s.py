...
SECTIONS = [
    ...
    (
        ...
        [
            ...
            ("11", "Rents", C, "1120S_L11", True, 50, DR),
            ("12", "Taxes and licenses", C, "1120S_L12", True, 60, DR),
            ...
            ("D_RENT_BUILDING", "Rent - Building", C, "", False, 392, DR),
            ("D_RENT_OTHER", "Rent - Other", C, "", False, 394, DR),
            ("D_SECU", "Security", C, "", False, 400, DR),
            ("D_SUPP", "Supplies", C, "", False, 410, DR),
            ("D_TAXES_OTHER", "Taxes - Other", C, "", False, 416, DR),
            ("D_TAXES_PAYROLL", "Taxes - Payroll", C, "", False, 417, DR),
            ("D_TAXES_PROPERTY", "Taxes - Property", C, "", False, 418, DR),
            ...
            ("D_FREE7_DESC", "", T, "", False, 560, DR),
            ("D_FREE7", "", C, "", False, 561, DR),
            ("D_FREE8_DESC", "", T, "", False, 570, DR),
            ("D_FREE8", "", C, "", False, 571, DR),
            ("D_FREE9_DESC", "", T, "", False, 580, DR),
            ("D_FREE9", "", C, "", False, 581, DR),
            ("D_FREE10_DESC", "", T, "", False, 590, DR),
            ("D_FREE10", "", C, "", False, 591, DR),
            ("D_FREE11_DESC", "", T, "", False, 595, DR),
            ("D_FREE11", "", C, "", False, 596, DR),
            # Summary lines
