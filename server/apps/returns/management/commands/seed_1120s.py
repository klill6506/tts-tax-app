...
SECTIONS = [
    ...
    (
        ...
        [
            ...
            ("L3d", "Inventories — end", C, "1120S_L3d_eoy", False, 44, DR),
            ...
            ("L10d", "Buildings & other depreciable assets — end", C, "1120S_L10d_eoy", False, 74, DR),
            ("L10e", "Less accumulated depreciation — end", C, "1120S_L10e_eoy", False, 76, CR),
            ...
            ("L13d", "Intangible assets — end", C, "1120S_L13d_eoy", False, 86, DR),
            ("L13e", "Less accumulated amortization — end", C, "1120S_L13e_eoy", False, 87, CR),
            ...
            ("L24d", "Retained earnings — end", C, "1120S_L24d_eoy", False, 260, CR),
            ...
            ("L27a", "AAA — beginning", C, "1120S_L27a_boy", False, 280, CR),
            ("L27d", "AAA — end", C, "1120S_L27d_eoy", False, 285, CR),
            ("L28a", "Total liabilities and equity — beginning", C, "", True, 310, CR),
            ("L28d", "Total liabilities and equity — end", C, "", True, 320, CR),
        ],
    ),
    # ------ SCHEDULE M-1 ------
    (
    ...
    (
        ...
        [
            ...
            ("M2_5a", "Other reductions (AAA)", C, "1120S_M2_5a", False, 50, DR),
