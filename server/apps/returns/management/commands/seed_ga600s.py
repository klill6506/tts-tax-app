...
SECTIONS = [
    ...
    (
        ...
        [
            ...
            ("S4_5a", "Balance of tax due — Income Tax", C, "", True, 50, DR),
            ("S4_5b", "Balance of tax due — Net Worth Tax", C, "", True, 51, DR),
            ("S4_5c", "Balance of tax due — Total", C, "", True, 52, DR),
            ("S4_6a", "Amount of overpayment — Income Tax", C, "", True, 60, CR),
            ("S4_6b", "Amount of overpayment — Net Worth Tax", C, "", True, 61, CR),
            ("S4_6c", "Amount of overpayment — Total", C, "", True, 62, CR),
            ...
            ("S4_10a", "Amount Due — Income Tax", C, "", True, 100, DR),
            ("S4_10b", "Amount Due — Net Worth Tax", C, "", True, 101, DR),
            ("S4_10c", "Amount Due — Total", C, "", True, 102, DR),
            ("S4_11a", "Credit to next year estimated tax — Income Tax", C, "", True, 110, CR),
            ("S4_11b", "Credit to next year estimated tax — Net Worth Tax", C, "", True, 111, CR),
            ("S4_11c", "Credit to next year estimated tax — Total", C, "", True, 112, CR),
        ],
    ),
