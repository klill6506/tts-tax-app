...
class TaxpayerSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
            ...
            # Schedule 8812 return-level inputs
            "taxpayer_has_valid_ssn",
            "spouse_has_valid_ssn",
            "spouse_has_ssn_or_itin_by_due_date",
            "files_form_2555",
            "form_2555_excluded_amount",
            "form_4563_excluded_income",
            "puerto_rico_excluded_income",
            "nontaxable_combat_pay",
            "claims_credits_requiring_worksheet_b",
            "taxpayer_has_rrta_taxes",
            # Placeholder inputs (Schedule 1/2/3, Form 8959, Schedule SE, EITC)
            "schedule_3_pre_ctc_credits_total",
            "additional_medicare_tax_amount",
            "deductible_se_tax_half",
            "se_tax_total",
            "unreported_ss_medicare_tax",
